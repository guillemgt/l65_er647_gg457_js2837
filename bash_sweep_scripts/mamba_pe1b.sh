...
for config in "${configs[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        options="main.py --cfg $config seed $seed wandb.project mamba_pe1b_devgpu wandb.entity l65 device cuda gt.layer_type CustomGatedGCN+MambaL65 gt.mamba_heuristics global_pe_1_bidirectional"
