...
for config in "${configs[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        options="main.py --cfg $config seed $seed wandb.project Experiments_round_1 wandb.entity l65 device cuda gt.layer_type CustomGatedGCN+Mamba_Hybrid_Degree_Noise"
