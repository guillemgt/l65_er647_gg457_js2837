...
for seed in "${seeds[@]}"; do
    ...
    options="main.py --cfg configs/Experiments/pascal-voc.yaml seed $seed  wandb.project mamba_pe2b_devgpu wandb.entity l65 device cuda gt.layer_type CustomGatedGCN+MambaL65 gt.mamba_heuristics global_pe_2_bidirectional"
